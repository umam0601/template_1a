...
<div class="row">
    <div class="col-md-5">
        <div class="ibox ">
            <div class="ibox-title">
                ...
                <h5><i class="fas fa-info-circle text-navy"></i>&nbsp; Form Input Barang Baru</h5>
            </div>
            <div class="ibox-content">
                <div class="form-input">
                    <div class="row">
                        <div class="col-md-5">
                            <label for="" class="label-form">Nama Barang</label>
                        </div>
                        <div class="col-md-7">
                            <input type="text" class="form-control form-control-sm" placeholder="Contoh: Indomie Sedap">
                        </div>
                    </div>
                </div>
                <div class="form-input">
    ...
    <div class="col-md-7">
        <div class="ibox ">
            <div class="ibox-title">
                <h5><i class="fas fa-info-circle text-navy"></i>&nbsp; Data Barang / Item</h5>
